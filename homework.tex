...
cholesterolu u indiánů žijícich ve měste bude větší něž u tich žijícich
na venkově. Proto vyberáme alternativní hypotézu $H_A:\ EU > ER$
...
{\color{incolor}In [{\color{incolor}9}]:} EU \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kp}{mean}\PY{p}{(}urban\PY{p}{)}
        ...
        \PY{k+kp}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Spodná hranica jednostranního konfidenčního intervalu pro EU je: \PYZdq{}}\PY{p}{,}EU\PY{o}{\PYZhy{}}error\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
\end{Verbatim}
